...
function Account() {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const response = await axios.post('http://192.168.0.16/profile.php', { email, password });
    ...
    const handleSaveChanges = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.16/updateProfile.php', JSON.stringify(editedProfile), {
    ...
    const handleSavePhoto = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.0.16/updateProfile.php', updatedProfile);
    ...
    const handleDeletePhoto = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.16/deleteProfilePic.php', { email });
    ...
    const handleChangePassword = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.16/verifyPassword.php', { email, currentPassword });
    ...
    const handleUpdatePassword = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.16/updatePassword.php', { email, newPassword });
