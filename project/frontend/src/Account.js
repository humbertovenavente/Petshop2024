...
function Account() {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const response = await axios.post('http://172.16.69.227/profile.php', { email, password });
    ...
    const handleSaveChanges = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://172.16.69.227/updateProfile.php', JSON.stringify(editedProfile), {
    ...
    const handleSavePhoto = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://172.16.69.227/updateProfile.php', updatedProfile);
    ...
    const handleDeletePhoto = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://172.16.69.227/deleteProfilePic.php', { email });
    ...
    const handleChangePassword = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://172.16.69.227/verifyPassword.php', { email, currentPassword });
    ...
    const handleUpdatePassword = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://172.16.69.227/updatePassword.php', { email, newPassword });
