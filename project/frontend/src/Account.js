...
function Account() {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const response = await axios.post('http://192.168.0.13/profile.php', { email, password });
    ...
    const handleSaveChanges = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.13/updateProfile.php', JSON.stringify(editedProfile), {
    ...
    const handleSavePhoto = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.0.13/updateProfile.php', updatedProfile);
    ...
    const handleDeletePhoto = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.13/deleteProfilePic.php', { email });
    ...
    const handleChangePassword = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.13/verifyPassword.php', { email, currentPassword });
    ...
    const handleUpdatePassword = async () => {
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.0.13/updatePassword.php', { email, newPassword });
