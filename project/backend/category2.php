...
$sql = "SELECT c1.id_category as main_category_id, c1.name as main_category_name, c2.id_category as related_category_id, c2.name as related_category_name
        ...
        WHERE c1.id_category != c2.id_category";  // Asegúrate de que 'ProductCategory' es tu tabla de relación
